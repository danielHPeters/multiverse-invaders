...
function init() {
    ...
    assetManager.downloadAll(() => {
        ...
        let area = new Area_1.Area(new TileSetMap_1.TileSetMap(assetManager.getSprite(CollideAble_1.EntityType.MAP), [ground, topLayer], ctx, 32, ground[0].length, ground.length, 16));
